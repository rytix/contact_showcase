export default function MessageCard() {
  return (
    <>
      <div className="flex flex-col sm:flex-row shadow-xl rounded-3xl border-2 border-solid border-gray-300 h-44 w-full mb-5">
        ...
        <div className="h-full w-full sm:w-3/5 md:w-4/5 text-xs md:text-sm mt-2">
          <p className="mb-2">
